...
Description: "If the type is Invasion into the fascia than the value is in MitoticIndexVS "
Severity:    #warning
...
Description: "If the type is Epstein Barr virus DNA [Units/volume] (viral load) in Serum or Plasma by NAA with probe detection or C reactive protein [Presence] in Serum or Plasma then the value is in PositiveNegativeNoTestVS "
Severity:    #warning
